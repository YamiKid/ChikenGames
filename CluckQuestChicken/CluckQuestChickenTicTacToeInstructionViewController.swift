...
class CluckQuestChickenTicTacToeInstructionViewController: UIViewController {
    ...
    private func CluckQuestSetupUI() {
        ...
        CluckQuestInstructionLabel.text = "Play against the AI! Get three in a row to win. Choose your difficulty and outsmart the chicken!"
    ...
    @objc private func CluckQuestStartTapped() {
        let vc = CluckQuestChickenTicTacToeDifficultyViewController()
