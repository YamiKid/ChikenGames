...
class CluckQuestChickenMemoryMatchDifficultyViewController: UIViewController {
    ...
    @objc private func CluckQuestChickenDifficultyTapped(_ sender: UIButton) {
        ...
        let vc = CluckQuestChickenMemoryMatchViewController()
        vc.selectedDifficulty = diff
