...
class CluckQuestPuzzleInstructionViewController: UIViewController {
    ...
    private func CluckQuestSetupUI() {
        ...
        CluckQuestInstructionLabel.text = "Drag the pieces into the gray grid to reconstruct the image."
    ...
    @objc private func CluckQuestStartTapped() {
        let vc = CluckQuestImageSelectionViewController()
